...
public class Tutorial : MonoBehaviour {
	...
	void OnTriggerEnter(Collider other)
	{
		...
		{
			popup.SetActive (true);
			popuptext.text="Drücke den roten Knopf auf dem Mikrofon, um eine Aufnahme zu beginnen und erneut um selbige zu stoppen. Hiernach solltest du dich zur Position 'Aufnahmeabspielen' teleportieren";
		}
